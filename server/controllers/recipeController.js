...
try{
    ...
    //It will collect 5 latest recipes from the dataBase
    const latest = await Recipe.find({}).sort({id_:-1}).limit(limitNum);
    ...
    res.render('index.ejs', {title : 'Cooking Blog - HomePage', categories, food});
 ...
 * Categories
 */
exports.exploeCategories = async(req, res) =>{
...
exports.exploeLatest = async(req, res) =>{
 ...
 */
 ...
 exports.exploeRandom = async(req, res) =>{
